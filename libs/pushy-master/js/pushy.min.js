! function(a) {
    ...
    function f() { a(t).addClass(v), a(t).on("click", function() {
            var b = a(this);
    ...
    var w = function() {
        ...
        if (null !== document.body) { document.body.insertBefore(a, null);
    ...
    else { h.addClass("no-csstransforms3d"), g.hasClass(k) ? g.css({ left: "-" + s }) : g.css({ right: "-" + s }), i.css({ "overflow-x": "hidden" });
        var x = !1;
